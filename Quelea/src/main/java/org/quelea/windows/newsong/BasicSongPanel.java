...
public class BasicSongPanel extends BorderPane {
    ...
    public BasicSongPanel() {
        ...
        chorusButton = getTitleButton("txt-c.png", "chorus.tooltip", "Chorus");
        preChorusButton = getTitleButton("txt-p.png", "prechorus.tooltip", "Pre-chorus");
        bridgeButton = getTitleButton("txt-b.png", "bridge.tooltip", "Bridge");
        tagButton = getTitleButton("txt-t.png", "tag.tooltip", "Tag");
    ...
    private SplitMenuButton getVerseButton() {
        ...
        m.setGraphic(new ImageView(new Image(darkTheme ? "file:icons/txt-v-light.png" : "file:icons/txt-v.png", 24, 24, false, true)));

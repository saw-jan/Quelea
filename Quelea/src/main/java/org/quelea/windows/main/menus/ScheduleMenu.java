...
public class ScheduleMenu extends Menu {
    ...
    public ScheduleMenu() {
        ...
        if (!Utils.isMac()) {
            addPowerpointItem.setGraphic(new ImageView(new Image(darkTheme ? "file:icons/ic-powerpoint-light.png" : "file:icons/ic-powerpoint.png", 20, 20, true, false)));
        }
        ...
        if (!Utils.isMac()) {
            addVideoItem.setGraphic(new ImageView(new Image(darkTheme ? "file:icons/ic-video-light.png" : "file:icons/ic-video.png", 20, 20, true, false)));
        }

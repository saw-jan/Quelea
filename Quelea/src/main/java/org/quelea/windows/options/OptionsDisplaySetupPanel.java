...
public class OptionsDisplaySetupPanel {
    ...
    Category getDisplaySetupTab() {
        return Category.of(LabelGrabber.INSTANCE.getLabel("display.options.heading"), new ImageView(new Image("file:icons/setting-ic-monitor.png")), //, new ImageView(new Image("file:icons/setting-ic-monitor.png")),

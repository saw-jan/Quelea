...
public class LibrarySongPanel extends BorderPane {
    ...
    public LibrarySongPanel() {
        ...
        searchCancelButton = new Button("", new ImageView(new Image(darkTheme ? "file:icons/ic-cancel.png" : "file:icons/ic-cancel-light.png", 16,16,false,true)));
        ...
        ImageView addIV = new ImageView(new Image(darkTheme ? "file:icons/ic-newsong-light.png" : "file:icons/ic-newsong.png"));
        ...
        ImageView removeIV = new ImageView(new Image(darkTheme ? "file:icons/ic-delete-white.png" : "file:icons/ic-delete-gray.png"));
